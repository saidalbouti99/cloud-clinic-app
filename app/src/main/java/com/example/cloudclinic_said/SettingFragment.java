...
public class SettingFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Button btnEditProfile = rootView.findViewById(R.id.btn_edit_profile_doctor);
        btnEditProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent;
                intent = new Intent(getActivity(), EditProfileDoctorActivity.class);
                startActivity(intent);
            }
        });
        final FirebaseAuth mFirebasAuth=FirebaseAuth.getInstance();
        Button btnchangepass=rootView.findViewById(R.id.btn_changepassword_doctor);
        ...
        Button btnLogout=  rootView.findViewById(R.id.btn_logout_doctor);
